...
Provenance notice: This approved report is historical implementation and review
evidence for the Workflow v3 automation update. It is not the current operating
guide; use [`YUTA_WORKFLOW_V3.md`](../../YUTA_WORKFLOW_V3.md) for that purpose. The
approved decisions recorded below are unchanged.
